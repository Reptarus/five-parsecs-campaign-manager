...
static func get_zone_size(deployment_type: int) -> Vector2:
...
func generate_deployment_zones(deployment_type: int) -> Array:
...
func _has_nearby_cover(position: Vector2) -> bool:
	for terrain in terrain_layout:
		if terrain.type == GlobalEnums.TerrainFeatureType.COVER_HIGH or terrain.type == GlobalEnums.TerrainFeatureType.COVER_LOW:
...
func _get_feature_size(feature_type: int) -> Vector2:
	match feature_type:
		GlobalEnums.TerrainFeatureType.COVER_LOW, GlobalEnums.TerrainFeatureType.COVER_HIGH:
			return Vector2(1, 1)
		GlobalEnums.TerrainFeatureType.DIFFICULT:
			return Vector2(2, 2)
		GlobalEnums.TerrainFeatureType.HAZARD:
			return Vector2(2, 1)
		GlobalEnums.TerrainFeatureType.ELEVATION_HIGH:
			return Vector2(2, 2)
