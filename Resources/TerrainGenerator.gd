...
func generate_terrain(table_size: String) -> Array:
...
func place_terrain_features(terrain_map: Array, table_size: String) -> void:
...
func place_terrain(terrain_map: Array, terrain_type: TerrainType, grid_size: Vector2i) -> void:
	var placed = false
	while not placed:
