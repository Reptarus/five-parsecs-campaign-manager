...
func _refresh_crew_list() -> void:
    ...
    for member in crew.members:
        var member_box = preload("res://Resources/CrewAndCharacters/Scenes/CharacterBox.tscn").instantiate()
...
func _on_add_member_pressed() -> void:
    ...
    var creator = preload("res://Resources/CrewAndCharacters/Scenes/CharacterCreator.tscn").instantiate()
    add_child(creator)
