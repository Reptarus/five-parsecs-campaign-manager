...
func test_remove_character() -> void:
	...
	character_manager.remove_character("test_character")
	assert_eq(character_manager.get_active_character_count(), 0)
	assert_null(character_manager.get_character("test_character"))
...
func test_load_all_characters() -> void:
	...
	assert_eq(character_manager.get_active_character_count(), 3)
	for i in range(3):
		var char_id := "test_character_%d" % i
		assert_not_null(character_manager.get_character(char_id))
