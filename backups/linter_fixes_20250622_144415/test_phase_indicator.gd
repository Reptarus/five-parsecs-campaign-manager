...
func test_initialization() -> void:
    ...
    assert_that(phase_indicator.name).is_equal("PhaseIndicator")
...
func test_phase_description() -> void:
    ...
    var expected_description = "New phase description"
