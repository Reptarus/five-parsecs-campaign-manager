...
#
	...
	if not has_correct_gdunit4_lifecycle(content):
		...
		"description": "			"expected": "Use before(), after(), before_test(), after_test() methods"
		})
...
#
	...
	instructions += "   \n"
	instructions += "   #
	instructions += "   extends GdUnitGameTest  #
	instructions += "   ```\n\n"
	...
	instructions += "   track_node(node)  #
	instructions += "   \n"
	instructions += "   var resource: Resource = var resource = Resource.new()\n"
	instructions += "   track_resource(resource)  #
	instructions += "   ```\n\n"
