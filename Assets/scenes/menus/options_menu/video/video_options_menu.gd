...
func setup_quality_options() -> void:
...
func _on_resolution_option_item_selected(index) -> void:
...
func _on_back_button_pressed() -> void:
    ...
    get_tree().call_deferred("change_scene_to_file", "res://assets/scenes/menus/main_menu.tscn")
