...
func test_ship_initialization() -> void:
	...
	var name: String = Compatibility.safe_cast_to_string(Compatibility.call_node_method(ship, "get_name", []))
	var description: String = Compatibility.safe_cast_to_string(Compatibility.call_node_method(ship, "get_description", []))
...
func test_add_component() -> void:
	...
	var components: Array = Compatibility.call_node_method_array(ship, "get_components", [])
	assert_true(components.has(component), "Ship should contain the added component")
	verify_signal_emitted(ship, "component_added")
...
func test_remove_component() -> void:
	...
	var components: Array = Compatibility.call_node_method_array(ship, "get_components", [])
	assert_false(components.has(component), "Ship should not contain the removed component")
	verify_signal_emitted(ship, "component_removed")
...
func test_get_component_by_id() -> void:
	...
	Compatibility.call_node_method_bool(ship, "add_component", [component])
	var retrieved: Resource = Compatibility.call_node_method(ship, "get_component_by_id", ["test_component"]) as Resource
