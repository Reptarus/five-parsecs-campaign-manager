...
func test_set_get_properties() -> void:
    ...
    var test_description: String = "A test ship for unit testing"
...
func test_add_component() -> void:
    ...
    var result = ship.add_component(component)
...
func test_remove_component() -> void:
    ...
    var result = ship.remove_component(component)
    assert_that(result).is_true()
...
func test_get_component_by_id() -> void:
    ...
    assert_that(retrieved).is_equal(component)
