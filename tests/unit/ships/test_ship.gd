...
func test_ship_components() -> void:
    ...
    var test_component = MockWeaponsComponent.new()
...
func test_ship_crew_capacity() -> void:
    ...
    assert_that(initial_capacity).is_equal(6)
...
func test_ship_power_system() -> void:
    ...
    assert_that(power_generation).is_equal(100)
