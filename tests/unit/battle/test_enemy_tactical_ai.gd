...
func before_each() -> void:
	...
	_battlefield_manager = TypeSafeMixin._safe_cast_node(battlefield_manager_instance)
	...
	_tactical_ai = TypeSafeMixin._safe_cast_node(tactical_ai_instance)
	if not _tactical_ai:
		push_error("Failed to create tactical AI")
		return
	TypeSafeMixin._safe_method_call_bool(_tactical_ai, "initialize", [_battlefield_manager, _combat_manager])
...
func _create_test_enemy(personality: int = GameEnums.AIPersonality.AGGRESSIVE) -> Node:
	...
	var enemy: Node = TypeSafeMixin._safe_cast_node(enemy_instance)
	if not enemy:
		push_error("Failed to create test enemy")
		return null
	
	TypeSafeMixin._safe_method_call_bool(enemy, "initialize", [])
	TypeSafeMixin._safe_method_call_bool(_tactical_ai, "set_enemy_personality", [enemy, personality])
...
func test_decision_making_signals() -> void:
	...
	_reset_signal_data()
	TypeSafeMixin._safe_method_call_bool(_tactical_ai, "emit_signal", ["decision_made", test_enemy, test_action])
...
func test_tactic_change_signals() -> void:
	...
	_reset_signal_data()
	TypeSafeMixin._safe_method_call_bool(_tactical_ai, "emit_signal", ["tactic_changed", test_enemy, test_tactic])
...
func test_group_coordination_signals() -> void:
	...
	_reset_signal_data()
	TypeSafeMixin._safe_method_call_bool(_tactical_ai, "emit_signal", ["group_coordination_updated", test_group, test_leader])
...
func test_enemy_personality_tracking() -> void:
	...
	TypeSafeMixin._safe_method_call_bool(_tactical_ai, "set_enemy_personality", [test_enemy, personality])
	var tracked_personality: int = TypeSafeMixin._safe_method_call_int(_tactical_ai, "get_enemy_personality", [test_enemy])
...
func test_group_assignment_tracking() -> void:
	...
	TypeSafeMixin._safe_method_call_bool(_tactical_ai, "assign_to_group", [test_enemy, test_group])
	var assigned_group: Array = TypeSafeMixin._safe_method_call_array(_tactical_ai, "get_enemy_group", [test_enemy])
...
func test_tactical_state_tracking() -> void:
	...
	TypeSafeMixin._safe_method_call_bool(_tactical_ai, "set_tactical_state", [test_enemy, tactical_state])
	var tracked_state: Dictionary = TypeSafeMixin._safe_method_call_dict(_tactical_ai, "get_tactical_state", [test_enemy])
...
func test_ai_decision_making() -> void:
	...
	TypeSafeMixin._safe_method_call_bool(_tactical_ai, "make_decision", [test_enemy])
...
func test_group_coordination() -> void:
	...
	TypeSafeMixin._safe_method_call_bool(_tactical_ai, "coordinate_group", [test_group])
...
func test_invalid_enemy_handling() -> void:
	var result: Dictionary = TypeSafeMixin._safe_method_call_dict(_tactical_ai, "make_decision", [null])
	...
	result = TypeSafeMixin._safe_method_call_dict(_tactical_ai, "make_decision", [invalid_enemy])
...
func test_decision_making_performance() -> void:
	...
	for enemy in enemies:
		TypeSafeMixin._safe_method_call_dict(_tactical_ai, "make_decision", [enemy])
