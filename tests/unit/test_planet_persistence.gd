...
func test_patron_has_planet_id_field() -> void:
	var patron := Patron.new("Test Patron", null, int(GlobalEnums.FactionType.NEUTRAL))
...
func test_patron_empty_planet_id_means_universal() -> void:
	var patron := Patron.new("Universal Patron", null, int(GlobalEnums.FactionType.NEUTRAL))
