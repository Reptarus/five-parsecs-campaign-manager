...
func test_all_difficulty_levels_are_valid():
	...
	assert_that(GlobalEnums.DifficultyLevel.NIGHTMARE).is_equal(5)
...
func test_difficulty_level_names_are_correct():
	...
	assert_that(GlobalEnums.get_difficulty_level_name(GlobalEnums.DifficultyLevel.NIGHTMARE)).is_equal("Nightmare")
