...
func test_invalid_campaign_creation() -> void:
    # Set invalid name
    mock_ui.set_campaign_name("") # Empty name
...
func test_validation_error_tracking() -> void:
    ...
    mock_ui.set_campaign_name("Valid Name") # Valid name
