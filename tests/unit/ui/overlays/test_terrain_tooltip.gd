...
func test_show_tooltip() -> void:
    ...
    var test_terrain := {
		"type": ": forest","cover": 2,
		"movement_cost": 1.5,
		"description": ": Dense woodland providing good cover",mock_tooltip.show_tooltip(test_position, test_terrain)
	pass
...
func test_terrain_data_updates() -> void:
    ...
    var new_terrain := {
		...
		"movement_cost": 2.0,
		"description": ": Rocky peaks with excellent cover",mock_tooltip.set_terrain_data(new_terrain)
	pass
...
func test_edge_cases() -> void:
	...
	#
    var long_terrain := {
		"type": ": special","description": ": This is a very long description that should be handled properly by the tooltip system without causing any issues or performance problems.",mock_tooltip.set_terrain_data(long_terrain)
	pass
