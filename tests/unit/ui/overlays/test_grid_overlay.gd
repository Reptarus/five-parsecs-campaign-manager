...
func test_snap_to_grid() -> void:
    ...
    #
    assert_that(snapped.x).is_equal(96.0) #
    assert_that(snapped.y).is_equal(128.0) #
...
func test_world_to_grid_conversion() -> void:
    ...
    #
    assert_that(grid_pos).is_equal(Vector2i(2, 3)) #
...
func test_grid_to_world_conversion() -> void:
    ...
    #
    assert_that(world_pos).is_equal(Vector2(192, 128)) #
...
func test_snap_precision() -> void:
    ...
    for i: int in range(test_positions.size()):
