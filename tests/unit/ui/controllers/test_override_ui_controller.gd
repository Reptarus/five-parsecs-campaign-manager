...
class MockOverrideUIController extends Resource:
	...
	var override_queue: @warning_ignore("unsafe_call_argument")
	Array[Dictionary] = []
	...
	# Override management
	var available_overrides: @warning_ignore("unsafe_call_argument")
	Array[String] = ["combat", "movement", "terrain", "equipment"]
	var override_history: @warning_ignore("unsafe_call_argument")
	Array[Dictionary] = []
	var pending_overrides: @warning_ignore("unsafe_call_argument")
	Array[Dictionary] = []
	...
	func apply_override(override_id: String) -> bool:
		for i: int in range(pending_overrides.size()):
	...
	override_data.has("_type") and @warning_ignore("unsafe_call_argument")
	override_data.has("data")
		@warning_ignore("unsafe_method_access")
...
func test_combat_system_setup() -> void:
	var mock_combat: Resource = Resource.new()
	var mock_ui: Resource = Resource.new()
	@warning_ignore("return_value_discarded")
