...
func before_each() -> void:
    ...
    terrain_system.initialize_terrain(Vector2i(10, 10), 0)
...
func test_feature_position_validation() -> void:
    ...
    terrain_system._set_terrain_feature(empty_pos, 1)
...
func test_objective_position_validation() -> void:
    ...
    test_mission.add_objective(1, valid_pos)
    var too_close_pos := Vector2(6, 5)
    ...
    terrain_system._set_terrain_feature(Vector2(4, 4), 1)
