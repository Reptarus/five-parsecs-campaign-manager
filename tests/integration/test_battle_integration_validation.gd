...
func test_battle_phase_start_flow() -> void:
	...
	phase_manager.force_phase_transition(int(GlobalEnums.FiveParsecsCampaignPhase.UPKEEP))
	await get_tree().process_frame
	...
	phase_manager.start_phase(int(GlobalEnums.FiveParsecsCampaignPhase.MISSION))
	...
	var valid_phases = [int(GlobalEnums.FiveParsecsCampaignPhase.MISSION), int(GlobalEnums.FiveParsecsCampaignPhase.POST_MISSION)]
...
func test_battle_to_postbattle_transition() -> void:
	...
	phase_manager.force_phase_transition(int(GlobalEnums.FiveParsecsCampaignPhase.MISSION))
	await get_tree().process_frame
	...
	assert_that(phase_manager.current_phase).is_equal(int(GlobalEnums.FiveParsecsCampaignPhase.POST_MISSION))\
