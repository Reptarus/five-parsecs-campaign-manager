...
func test_can_rollback_from_battle_to_world():
	...
	var result = phase_manager.rollback_to_phase(GlobalEnums.FiveParsecsCampaignPhase.UPKEEP)
...
func test_cannot_rollback_from_post_battle():
	...
	var result = phase_manager.rollback_to_phase(GlobalEnums.FiveParsecsCampaignPhase.MISSION)
