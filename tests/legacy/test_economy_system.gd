...
func _init():
	...
	if gear_init_success:
		...
		print("  Name: %s" % initialized_gear.gear_name)
		print("  Category: %s" % initialized_gear.gear_category)
		print("  Traits: %s" % str(initialized_gear.gear_traits))
		print("  Cost: %d credits" % initialized_gear.gear_cost.get("credits", 0))
	else:
