...
func set_current_phase(phase: GlobalEnums.FiveParsecsCampaignPhase) -> bool:
	...
	if phase == GlobalEnums.FiveParsecsCampaignPhase.WORLD:
		current_world_step = 0
...
func can_advance_to_phase(target_phase: GlobalEnums.FiveParsecsCampaignPhase) -> bool:
	...
	match current_phase:
		...
		GlobalEnums.FiveParsecsCampaignPhase.WORLD:
			return target_phase == GlobalEnums.FiveParsecsCampaignPhase.BATTLE and is_world_phase_complete()
		
		GlobalEnums.FiveParsecsCampaignPhase.BATTLE:
			return target_phase == GlobalEnums.FiveParsecsCampaignPhase.POST_BATTLE
...
func validate_state_consistency() -> bool:
	...
	if current_phase == GlobalEnums.FiveParsecsCampaignPhase.WORLD and current_world_step >= world_step_names.size():
