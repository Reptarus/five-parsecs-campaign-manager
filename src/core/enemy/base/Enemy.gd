...
func _initialize_from_data() -> void:
	...
	if enemy_data and enemy_data.has_method("get_health"):
...
func get_weapon() -> Resource:
	return enemy_data.get_weapon() if enemy_data and enemy_data and enemy_data.has_method("get_weapon") else null
