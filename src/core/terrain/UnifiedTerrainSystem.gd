...
func place_terrain(position: Vector2i, terrain_type: TerrainTypes.Type, feature_type: GameEnums.TerrainFeatureType = GameEnums.TerrainFeatureType.NONE) -> bool:
...
func modify_terrain(position: Vector2i, new_type: TerrainTypes.Type, feature_type: GameEnums.TerrainFeatureType = GameEnums.TerrainFeatureType.NONE) -> bool:
...
func apply_terrain_effect(target: Node, terrain_type: TerrainTypes.Type) -> void:
