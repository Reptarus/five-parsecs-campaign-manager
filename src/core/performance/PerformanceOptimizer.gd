...
func _initialize_performance_system() -> void:
	...
	_resource_pools = {
		"textures": ResourcePool.new("textures", 50),
		"audio_streams": ResourcePool.new("audio_streams", 20),
		"scenes": ResourcePool.new("scenes", 10),
		"meshes": ResourcePool.new("meshes", 30)
	}
