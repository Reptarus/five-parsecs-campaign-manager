...
static func resolve_battle(
	...
	return {
		...
		"battlefield_finds": randi_range(0, 2) if outcome["held_field"] else 0,
...
static func initialize_battle(
	...
	match condition_id:
		"ambush":
			...
			battle_state["condition_effects"]["crew_hit_bonus"] = 2
		"surrounded":
			battle_state["condition_effects"]["enemy_bonus"] = 2
			battle_state["condition_effects"]["crew_hit_penalty"] = -1
		"defensive":
			battle_state["condition_effects"]["crew_cover_bonus"] = 1
		"headlong_assault":
			battle_state["condition_effects"]["no_cover"] = true
			battle_state["condition_effects"]["crew_hit_bonus"] = 1
		_:
...
static func _estimate_range(attacker: Dictionary, target: Dictionary, battlefield_data: Dictionary) -> float:
	...
	return randf_range(6.0, float(weapon_range))
...
static func _has_cover(unit: Dictionary, battlefield_data: Dictionary, condition_effects: Dictionary) -> bool:
	...
	# Simplified: 50% of units have cover by default
