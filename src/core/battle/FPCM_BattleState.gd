...
# Companion tier tracking
@export var tracking_tier: int = 0 # FPCM_BattleTierController.TrackingTier
@export var tier_specific_data: Dictionary = {}
...
func export_save_data() -> Dictionary:
	return {
		...
		"tier_specific_data": tier_specific_data
	}
...
func import_save_data(save_data: Dictionary) -> bool:
	...
	tracking_tier = save_data.get("tracking_tier", 0)
	tier_specific_data = save_data.get("tier_specific_data", {})
