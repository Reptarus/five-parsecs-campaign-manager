...
const TAGS: Dictionary = {
	...
	"victory": {"label": "Victory", "color": Color("#10B981")},
	"defeat": {"label": "Defeat", "color": Color("#1F2937")},
	"held_field": {"label": "Held the Field", "color": Color("#F59E0B")},
	"bitter_day": {"label": "A Bitter Day", "color": Color("#DC2626")},
	"loot": {"label": "Loot", "color": Color("#F59E0B")},
	"payment": {"label": "Payment", "color": Color("#10B981")},
	"rewards": {"label": "Rewards", "color": Color("#10B981")},
	"invasion": {"label": "Invasion", "color": Color("#DC2626")},
	"galactic_war": {"label": "Galactic War", "color": Color("#DC2626")},
	"campaign_event": {"label": "Campaign Event", "color": Color("#A78BFA")},
	"character_event": {"label": "Character Event", "color": Color("#A78BFA")},
	"quest": {"label": "Quest", "color": Color("#8B5CF6")},
	"story_points": {"label": "Story Points", "color": Color("#8B5CF6")},
	"upkeep": {"label": "Upkeep", "color": Color("#10B981")},
	"trading": {"label": "Trading", "color": Color("#10B981")},
	"departure": {"label": "Departure", "color": Color("#6B7280")},
	"return": {"label": "Return", "color": Color("#06B6D4")},
	"completion": {"label": "Completion", "color": Color("#34D399")},
	"unlock": {"label": "Unlock", "color": Color("#F59E0B")},
	"introductory_campaign": {"label": "Introductory Campaign", "color": Color("#A78BFA")},
	"experience": {"label": "Experience", "color": Color("#34D399")},
	"recovery": {"label": "Recovery", "color": Color("#D97706")},
	"medical_bay": {"label": "Medical Bay", "color": Color("#D97706")},
	"crew_dismissed": {"label": "Crew Dismissed", "color": Color("#6B7280")},
	"business_elsewhere": {"label": "Business Elsewhere", "color": Color("#6B7280")},
	"item_recovery": {"label": "Item Recovery", "color": Color("#F59E0B")},
	"species_ability": {"label": "Species Ability", "color": Color("#8B5CF6")},
	"strange_character": {"label": "Strange Character", "color": Color("#8B5CF6")},
	"psionics": {"label": "Psionics", "color": Color("#8B5CF6")},
	"feeler": {"label": "Feeler", "color": Color("#8B5CF6")},
	"swift": {"label": "Swift", "color": Color("#8B5CF6")},
	"traveler": {"label": "Traveler", "color": Color("#8B5CF6")},
	"unity_agent": {"label": "Unity Agent", "color": Color("#8B5CF6")},
	"manipulator": {"label": "Manipulator", "color": Color("#8B5CF6")},
	"ship_component": {"label": "Ship Component", "color": Color("#3B82F6")},
	"component": {"label": "Component", "color": Color("#3B82F6")},
	"installation": {"label": "Installation", "color": Color("#3B82F6")},
	"improved_shielding": {"label": "Improved Shielding", "color": Color("#3B82F6")},
	"bug_hunt": {"label": "Bug Hunt", "color": Color("#84CC16")},
	"planetfall": {"label": "Planetfall", "color": Color("#34D399")},
	"tactics": {"label": "Tactics", "color": Color("#3B82F6")},
	"compendium": {"label": "Compendium", "color": Color("#A78BFA")},
	"expanded_database": {"label": "Expanded Database", "color": Color("#A78BFA")},
	"d100": {"label": "D100 Roll", "color": Color("#6B7280")},
}
