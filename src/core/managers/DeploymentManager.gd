...
# (Two orphan static helpers — infer_terrain_features / infer_deployment_type —
# were deleted here 2026-07-02: zero callers across src/ and tests/; the
# CLAUDE.md claim that they were a live pattern was stale.)
