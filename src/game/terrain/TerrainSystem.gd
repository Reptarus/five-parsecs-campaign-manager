...
const FiveParcecsTerrainTypes: GDScript = preload("res://src/game/terrain/TerrainTypes.gd")
const FiveParcecsTerrainRules: GDScript = preload("res://src/game/terrain/TerrainRules.gd")
