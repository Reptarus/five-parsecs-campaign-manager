...
const CharacterCreator = preload("res://src/game/character/generation/CharacterCreator.gd")
const GameEnums = preload("res://src/core/systems/GlobalEnums.gd")
const FiveParsecsGameState = preload("res://src/core/state/GameState.gd")

@onready var character_list: Button = $"Panel/HSplitContainer/CharacterList/ItemList"
@onready var remove_button: Button = $"Panel/HSplitContainer/CharacterList/ButtonContainer/RemoveButton"

# Stats tab references
@onready var name_value: LineEdit = $"Panel/HSplitContainer/CharacterDetails/TabContainer/Stats/VBoxContainer/BasicInfo/NameValue"
@onready var origin_value: LineEdit = $"Panel/HSplitContainer/CharacterDetails/TabContainer/Stats/VBoxContainer/BasicInfo/OriginValue"
