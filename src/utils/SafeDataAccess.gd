...
static func safe_get(obj: Variant, key: String, default_value: Variant = null, context: String = "") -> Variant:
	...
	push_warning("SafeDataAccess: Expected Dictionary for key '%s'%s, got %s. Using default value." % [key, context_msg, typeof(obj)])
...
static func safe_dict_access(obj: Variant, operation_name: String = "data access") -> Dictionary:
	...
	push_warning("SafeDataAccess: %s - Expected Dictionary, got %s. Using empty dictionary." % [operation_name, typeof(obj)])
	return {}
...
static func safe_array_access(obj: Variant, operation_name: String = "array access") -> Array:
	...
	push_warning("SafeDataAccess: %s - Expected Array, got %s. Using empty array." % [operation_name, typeof(obj)])
	return []
...
static func safe_string_access(obj: Variant, default_value: String = "", operation_name: String = "string access") -> String:
	...
	push_warning("SafeDataAccess: %s - Expected String, got %s. Using default value." % [operation_name, typeof(obj)])
	return default_value
...
static func safe_int_access(obj: Variant, default_value: int = 0, operation_name: String = "integer access") -> int:
	...
	push_warning("SafeDataAccess: %s - Expected int, got %s. Using default value." % [operation_name, typeof(obj)])
	return default_value
...
static func safe_float_access(obj: Variant, default_value: float = 0.0, operation_name: String = "float access") -> float:
	...
	push_warning("SafeDataAccess: %s - Expected float, got %s. Using default value." % [operation_name, typeof(obj)])
	return default_value
...
static func safe_bool_access(obj: Variant, default_value: bool = false, operation_name: String = "boolean access") -> bool:
	...
	push_warning("SafeDataAccess: %s - Expected bool, got %s. Using default value." % [operation_name, typeof(obj)])
	return default_value
...
static func validate_data_structure(data: Variant, expected_keys: Array[String], context: String = "") -> Dictionary:
	...
	if not data is Dictionary:
		result.type_errors.append("Expected Dictionary, got %s" % typeof(data))
...
static func enhanced_safe_get(obj: Variant, key: String, default_value: Variant = null, context: String = "") -> Variant:
	...
	var context_msg = " in " + context if context != "" else ""
	push_warning("SafeDataAccess: Enhanced access failed for key '%s'%s. Object type: %s. Using default value." % [key, context_msg, typeof(obj)])
	return default_value
...
static func deep_safe_get(obj: Variant, key_path: Array[String], default_value: Variant = null, context: String = "") -> Variant:
	...
	for i in range(key_path.size()):
		...
		if not current_obj is Dictionary:
			push_warning("SafeDataAccess: Deep access failed at key '%s' in %s. Expected Dictionary, got %s." % [key, path_context, typeof(current_obj)])
			return default_value
