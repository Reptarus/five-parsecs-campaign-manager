...
@export var class_abilities: Array[Dictionary] = []
...
func has_class_ability(ability_name: String) -> bool:
	"""Check if this class has a specific ability"""
	for ability in class_abilities:
		if ability.get("name", "") == ability_name:
			return true
	return false

func get_class_ability(ability_name: String) -> Dictionary:
	"""Get a specific class ability"""
	for ability in class_abilities:
		if ability.get("name", "") == ability_name:
			return ability
	return {}
...
func has_tag(tag: String) -> bool:
	"""Check if this class has a specific tag"""
	return tag in tags
