...
func _predict_dice_type_for_task(task_type: int) -> String:
	match task_type:
		...
		GlobalEnums.CrewTaskType.DECOY:
			return "2d6"
		GlobalEnums.CrewTaskType.TRADE, GlobalEnums.CrewTaskType.RECRUIT, GlobalEnums.CrewTaskType.TRAIN, GlobalEnums.CrewTaskType.TRACK, GlobalEnums.CrewTaskType.REPAIR:
			return "d6"
		_:
			return "d6"
