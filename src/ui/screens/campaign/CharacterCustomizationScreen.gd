...
func _on_reroll_attributes() -> void:
	...
	CharacterGeneration.generate_character_attributes(editing_character)
...
func _on_generate_relationships() -> void:
	...
	editing_character.patrons = CharacterGeneration.generate_patrons(editing_character)
	editing_character.rivals = CharacterGeneration.generate_rivals(editing_character)

	# Apply background and motivation effects
	CharacterGeneration.apply_background_effects(editing_character)
	CharacterGeneration.apply_motivation_effects(editing_character)
...
func _on_generate_equipment() -> void:
	...
	editing_character.personal_equipment = CharacterGeneration.generate_starting_equipment_enhanced(editing_character)
