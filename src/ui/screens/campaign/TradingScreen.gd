...
func _create_header() -> HBoxContainer:
	...
	market_condition_label.add_theme_color_override("font_color", Color(0.7, 0.7, 0.7))
...
func _create_inventory_section() -> PanelContainer:
	...
	section_title.add_theme_font_size_override("font_size", 16)
	section_title.add_theme_color_override("font_color", Color(0.4, 1.0, 0.4))
	section_header.add_child(section_title)
...
func _create_inventory_item_row(item: Variant, index: int) -> PanelContainer:
	...
	value_label.add_theme_color_override("font_color", Color(0.8, 0.8, 0.4))
