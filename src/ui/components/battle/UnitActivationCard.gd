...
# Visual states
const COLOR_ACTIVATED := Color("#10B981")      # Green - acted
const COLOR_NOT_ACTED := Color("#808080")      # Gray - not acted
const COLOR_CANNOT_ACT := Color("#DC2626")     # Red - cannot act
const COLOR_TEXT_PRIMARY := Color("#E0E0E0")
const COLOR_TEXT_SECONDARY := Color("#808080")

# Team colors
const COLOR_CREW := Color("#3B82F6")           # Blue border
const COLOR_ENEMY := Color("#EF4444")          # Red border

# Health bar colors
const COLOR_HEALTH_HIGH := Color("#10B981")    # Green (>66%)
const COLOR_HEALTH_MED := Color("#F59E0B")     # Amber (33-66%)
const COLOR_HEALTH_LOW := Color("#DC2626")     # Red (<33%)
