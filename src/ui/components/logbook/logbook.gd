...
func _setup_buttons() -> void:
	var new_entry_button: Button = $MarginContainer/HBoxContainer/Sidebar/ButtonsContainer/NewEntryButton
	var delete_entry_button: Button = $MarginContainer/HBoxContainer/Sidebar/ButtonsContainer/DeleteEntryButton
	var export_button = $MarginContainer/HBoxContainer/Sidebar/ExportButton
	var back_button: Button = $MarginContainer/HBoxContainer/Sidebar/BackButton
	var save_button: Button = $MarginContainer/HBoxContainer/MainContent/SaveButton
