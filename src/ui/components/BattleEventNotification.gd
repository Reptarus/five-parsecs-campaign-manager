...
var event_type_colors := {
	0: UIColors.COLOR_AMBER, # ENVIRONMENTAL_HAZARD
	1: UIColors.COLOR_RED, # REINFORCEMENTS
	2: UIColors.COLOR_CYAN, # WEATHER_CHANGE
	3: UIColors.COLOR_AMBER, # EQUIPMENT_MALFUNCTION
	4: UIColors.COLOR_PURPLE, # MORALE_CHECK
...
func _update_event_styling() -> void:
	...
	if style is StyleBoxFlat:
		var type_color: Color = event_type_colors.get(event_data.event_type, UIColors.COLOR_CYAN)
...
func _setup_action_buttons() -> void:
	...
	if event_data and event_data.requires_dice_roll:
		...
		dice_btn.modulate = UIColors.COLOR_AMBER
	...
	details_btn.modulate = UIColors.COLOR_CYAN
...
func _create_details_popup() -> AcceptDialog:
	...
	if event_data and event_data.special_instructions != "":
		...
		instructions_text.modulate = UIColors.COLOR_AMBER
