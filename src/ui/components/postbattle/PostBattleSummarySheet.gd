...
# Color Palette
const COLOR_PRIMARY := UIColors.COLOR_PRIMARY        # Darkest background
const COLOR_SECONDARY := UIColors.COLOR_SECONDARY    # Card backgrounds
const COLOR_TERTIARY := UIColors.COLOR_TERTIARY      # Elevated elements
const COLOR_BORDER := UIColors.COLOR_BORDER          # Borders

const COLOR_SUCCESS := UIColors.COLOR_SUCCESS        # Victory, positive changes
const COLOR_DANGER := UIColors.COLOR_DANGER          # Defeat, deaths, warnings
const COLOR_WARNING := UIColors.COLOR_WARNING        # Injuries, cautions
const COLOR_CYAN := UIColors.COLOR_CYAN              # Info, neutral changes

const COLOR_TEXT_PRIMARY := UIColors.COLOR_TEXT_PRIMARY     # Bright white text
const COLOR_TEXT_SECONDARY := UIColors.COLOR_TEXT_SECONDARY # Gray secondary text
