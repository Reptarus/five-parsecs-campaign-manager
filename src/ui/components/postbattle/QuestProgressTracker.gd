...
const COLOR_WARNING := UIColors.COLOR_WARNING    # Amber - Dead end
const COLOR_SUCCESS := UIColors.COLOR_SUCCESS    # Green - Progress
const COLOR_ACCENT := UIColors.COLOR_BLUE        # Blue - Finale ready
