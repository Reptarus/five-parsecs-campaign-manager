...
# Design constants from UIColors
...
const COLOR_CYAN := UIColors.COLOR_CYAN              # Save
const COLOR_BLUE := UIColors.COLOR_BLUE              # Characters
const COLOR_PURPLE := UIColors.COLOR_PURPLE          # Ship
const COLOR_AMBER := UIColors.COLOR_AMBER            # Trading
const COLOR_EMERALD := UIColors.COLOR_EMERALD        # World
const COLOR_TEXT_SECONDARY := UIColors.COLOR_TEXT_SECONDARY  # Settings
