...
var ManualOverridePanel = preload("res://src/ui/components/combat/overrides/manual_override_panel.tscn")
var panel: Node
...
func test_apply_button_emits_signal() -> void:
	...
	assert_signal_emitted_with_parameters(panel, "override_applied", [4])
