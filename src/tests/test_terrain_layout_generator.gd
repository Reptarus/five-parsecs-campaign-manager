...
func test_open_layout_generation():
...
func test_dense_layout_generation():
...
func test_asymmetric_layout_generation():
...
func test_corridor_layout_generation():
...
func test_scattered_layout_generation():
