...
**Last Updated**: 2026-09-03 (**Sep 2026 page walk** — the pages the Aug audits never reached: Core Rules appendices II/IV/VI/VII/VIII, the Compendium chapters marked DEAD, the designer errata v1.06 and FAQ, and a diff of the battle Cheat Sheet against the PDFs — then a second walk of the Core Rules MAIN chapters pp.12-135, the range no subsystem audit ever owned. 18 fixed + 2 corrected; section at the bottom of [docs/RULES_WIRING_AUDIT_2026-08.md](docs/RULES_WIRING_AUDIT_2026-08.md). Tablet QA from Aug 8-14 is still PAUSED — [docs/qa/PICKUP_2026-08-14.md](docs/qa/PICKUP_2026-08-14.md) is unchanged and still the pickup doc for that.)
