...
@onready var victory_condition_container: HBoxContainer = $VBoxContainer/VictoryConditionContainer
@onready var victory_type_label: Label = $VBoxContainer/VictoryConditionContainer/VictoryTypeLabel
@onready var victory_count_label: Label = $VBoxContainer/VictoryConditionContainer/VictoryCountLabel
