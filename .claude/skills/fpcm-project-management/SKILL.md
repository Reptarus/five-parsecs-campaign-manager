...
| `ui-panel-developer` | sonnet | UI, theme, TweenFX, navigation | panel, UI, screen, theme, animation, TweenFX, style |
| `bug-hunt-specialist` | sonnet | Bug Hunt gamemode, cross-mode safety | bug hunt, grunt, regiment, cross-mode, transfer |
| `qa-specialist` | opus | Testing, QA, bugs, regression | test, QA, bug, verify, validate, audit, sweep |
