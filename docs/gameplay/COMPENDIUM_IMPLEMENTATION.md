...
- 🟡 Advanced psionic schools
- 🟡 Some ship parts
- 🟡 Dramatic combat
- 🟡 Grid-based movement
- 🟡 Critical hit system
- 🟡 Elite enemies (some types)
- 🟡 PvP online features

### Not Implemented 🔴 (Planned for Future)

- 🔴 Bug Hunt campaign variant
- 🔴 Advanced psionic items
- 🔴 Some ship upgrades
- 🔴 No-minis mode (not applicable)
- 🔴 Some dramatic combat features
- 🔴 Elite enemy types (remaining)

### Not Planned ❌ (Out of Scope)

- ❌ No-minis combat (digital version is the minis)
...
*Compendium Implementation: ~85% Complete*