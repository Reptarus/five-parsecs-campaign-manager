...
> **Implementation Note (Feb 2026)**: This system is fully implemented and wired into the campaign loop.
> - **CampaignJournal autoload**: `src/core/campaign/CampaignJournal.gd` (578 lines, full implementation)
> - **CharacterHistoryPanel**: `src/ui/components/history/CharacterHistoryPanel.gd` (lifetime stats, advancement history, journal entries per character)
> - **CampaignTimelinePanel**: `src/ui/components/history/CampaignTimelinePanel.gd` (filter by type, crew stats, top performers, Markdown/JSON export)
> - **ExportPanel**: `src/ui/components/export/ExportPanel.gd` (Full Campaign / Crew Only / Journal Only export, JSON + Markdown formats)
> - **ImportPanel**: `src/ui/components/export/ImportPanel.gd` (JSON import with validation and preview)
> - **Dashboard integration**: History, Export, Import buttons in CampaignDashboard with overlay system
> - **Auto-generation**: PostBattlePhase creates battle entries; CampaignPhaseManager creates milestone entries at turns 5/10/20/30/50/75/100
> - **Thin redirect**: `src/qol/CampaignJournal.gd` extends the autoloaded version (preserves old preload paths)
...
- [x] CampaignJournal.gd core functionality
- [x] Auto-generation from battle results
- [x] Auto-generation from character events
- [x] Manual entry creation UI
- [x] Timeline visualization
- [x] Character history view
- [x] Photo attachment system
- [x] Markdown export working
- [x] JSON export working
- [x] Save/load preserves entries
- [ ] Mobile-optimized UI (pending mobile testing)
- [x] Search/filter functional
- [ ] Unit tests pass (90%+ coverage) (pending test reverification on Godot 4.6)

---

**Implementation Complete**: February 2026 (Sprints 5-7 of 4-Feature Plan + Sprints 8-9 for Import/Export)
