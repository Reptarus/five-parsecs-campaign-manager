...
| [x] ExpandedConfigPanel.tscn | `src/ui/screens/campaign/panels/` | ✅ DONE (Consolidated from ConfigPanel) |
...
| [x] ExpandedConfigPanel.gd | ✅ Extends | ✅ Victory cards + Difficulty + Crew Size + House Rules | ✅ CONSOLIDATED |
