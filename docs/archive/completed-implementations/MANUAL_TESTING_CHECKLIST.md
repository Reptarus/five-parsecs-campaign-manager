...
2. **ExpandedConfigPanel (Step 1/7)** *(Consolidated from ConfigPanel)*:
   - Set campaign name: "Test Campaign Alpha"
   - Difficulty: "Standard" (5 levels: Story → Nightmare)
   - Crew Size: 6 (Standard)
   - Victory Conditions: Select at least one
