...
**Purpose**: Provides simplified API for GUT compatibility  
...
"/mnt/c/Users/admin/Desktop/GoDot/Godot 4.6/Godot_v4.4.1-stable_win64_console.exe" \
  --headless --path . -s res://addons/GUT/bin/GdUnitCmdTool.gd \
