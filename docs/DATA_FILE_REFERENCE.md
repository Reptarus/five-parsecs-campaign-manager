...
| File | Purpose |
|------|---------|
| `crew_task_resolution.json` | Task outcome tables |
| `exploration_events.json` | Exploration results |
| `recruitment_opportunities.json` | Hire new crew |
| `trade_results.json` | Trading outcomes |
| `training_outcomes.json` | Training results |

### World Phase (`data/campaign_tables/world_phase/`)
| File | Purpose |
|------|---------|
| `crew_task_modifiers.json` | Task bonuses/penalties |
| `patron_jobs.json` | Patron job offers |
| `world_step_exploration.json` | Explore world |
| `world_step_trade.json` | Trade goods |
...
| `world_traits.json` | World modifiers |
